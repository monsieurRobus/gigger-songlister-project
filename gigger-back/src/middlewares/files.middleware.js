...
storage = new CloudinaryStorage({   cloudinary: cloudinary,   params: {     folder: 'files',     allowedFormats: ['jpg', 'png', 'jpeg', 'gif', 'webp', 'pdf'],   }, });  
...
module.exports = { uploadUser, deleteImgCloudinary, configCloudinary };
